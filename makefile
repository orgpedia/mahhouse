...
import/websites/gr.maharashtra.gov.in/Housing:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Housing .
...
import: check_env import/websites/gr.maharashtra.gov.in/Housing .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Housing import/documents
